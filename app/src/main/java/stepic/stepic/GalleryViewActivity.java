...
public class GalleryViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Image data = GalleryActivity.selected_data;
        ImageView img = (ImageView) findViewById(R.id.selected_image);
        if(data.url_memory!=-1){
            Glide.with(this).load(data.url_memory).override(200, 200).into(img);
        }else {
            String real_path = getPath(data.url);
